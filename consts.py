...
# The total time it takes a ship to die
DEATH_SPEED = .3
...
HEART_HEIGHT = 44
# the time a heart takes to complete one full animation cycle
HEART_SPEED = .5
# The time it takes for a heart to recall a heart animation
HEART_TIME = 3
